...
(() => {
  ...
  function _t(t, e) {
    ...
    var i = e,
      ...
      M = gt({ reference: I, element: k, strategy: "absolute", placement: a }),
  ...
  class Ln extends ve {
    ...
    show(t) {
      this._isShown ||
        ...
        fe.trigger(this._element, _n, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
  ...
  class Kn extends ve {
    ...
    show(t) {
      this._isShown ||
        fe.trigger(this._element, jn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
    ...
    _addEventListeners() {
      fe.on(this._element, qn, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : fe.trigger(this._element, Bn));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  fe.on(document, Rn, '[data-bs-toggle="offcanvas"]', function (t) {
    ...
    fe.on(window, zn, () => {
      for (const t of we.find("[aria-modal][class*=show][class*=offcanvas-]"))
  ...
  class Ls extends ve {
    ...
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        we.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(
          As,
        );
      else
  ...
  class Js extends ve {
    ...
    _toggleDropDown(t, e) {
      ...
      n(Ks, qs), n(".dropdown-menu", Ys), i.setAttribute("aria-expanded", e);
    }
